...
```
STL decomposition showcase a couple of usefull plots that helps understand the AQI data and how they change over time. The overall trend is overall going downwards, with the exception of 2024 year. The yearly and daily patter ale clearly visible, indicating that data has yearly and daily seasonality present. On the other hand weekly patter is looking pretty random, meaning that the AQI is not influenced much by day of the week.
...
This is likely caused by heating in the winter months (by PM2.5) and in the summer because of frequent O3 pollution.
...
The hourly plot shows that there is a slight peak at around 6am, then slightly dips down, and around 9-10 it starts climbing again till the late night hours.
