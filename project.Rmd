...
@TODO
The core assumption of ordinal regression is proportional odds, the coefficients that describe relationships between categories are the same. 
...
H0: parallel regression assumption holds. Rejection (p < 0.05) means that predictor's effect differs across categories. As we can see in the output, most of the predictors are violating this assumption, making the modeled probabilities incorect for categories.
