...
Features that matter in both families, such as pollutants, lagged AQI and weather variables like pressure, were highly useful for AQI predictions. Non-parametric models expose this through permutation importance, while with parametric models it can be analyzed by looking at the coefficients and statistical significance, noting that some assumptions are violated in this dataset. An interesting variable is Snowfall, as the dataset contains very few hours with recorded snowfall. Parametric models interpret this as highly influential parameter, while the non-parametric models have it as one of the lowest important features.
